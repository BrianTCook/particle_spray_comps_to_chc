...
def extract_particle_data(
    ...
    pot = stream_info_dict["hamiltonian"].potential
    E = pot.total_energy(particle.pos.xyz, particle.vel.d_xyz)
    ...
    return pd.DataFrame(
        {
            ...
            "E_wrt_host": E.to(u.km**2 / u.s**2).value,
